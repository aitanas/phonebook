using System;
using System.Collections.Generic; //must add to any program file that uses a dict
...
class PhoneBook
{
  ...
  static void Main()
  {
    ...
    Console.WriteLine("Would you like to a person to your phone book? ['Y' for yes, 'Enter' for no]");
